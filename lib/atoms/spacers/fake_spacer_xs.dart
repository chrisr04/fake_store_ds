...
/// A spacer widget with a extra small size spacing. This widget is useful for adding
/// empty space between elements in a layout. It wraps a [FakeSpacer] widget
/// and sets its size to large (xs).
///
/// Example:
/// ```dart
/// FakeSpacerXS(
...
/// )
/// ```
class FakeSpacerXS extends StatelessWidget {
  /// Creates a fake spacer widget with a extra small size spacing.
  ///
  /// The [axis] parameter determines whether the spacer should be x (horizontal) or y (vertical).
  const FakeSpacerXS({super.key, this.axis});
